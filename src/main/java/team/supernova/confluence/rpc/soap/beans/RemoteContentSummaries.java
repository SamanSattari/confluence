...
public class RemoteContentSummaries  implements java.io.Serializable {
    private team.supernova.confluence.rpc.soap.beans.RemoteContentSummary[] content;
    ...
    public RemoteContentSummaries(
           team.supernova.confluence.rpc.soap.beans.RemoteContentSummary[] content,
           int offset,
           int totalAvailable) {
     ...
     * @return content
     */
    public team.supernova.confluence.rpc.soap.beans.RemoteContentSummary[] getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(team.supernova.confluence.rpc.soap.beans.RemoteContentSummary[] content) {
        this.content = content;
    }
